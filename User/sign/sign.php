                ...
                <div style="background: #fff; border-radius: 10px;" class="shadow-sm">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-7 m-auto mt-5">
                                      ...
                                      <h6 style="font-size: 12px; margin-top: 10px;">I don't Have Already Account ? <a href="regi.php">Registration</a></h6>
                                      <h6 style="font-size: 12px; margin-top: 10px;">Admin - <a href="../../Admin/sign/sign.php">Admin</a></h6>
                            ...
                            <div class="col-md-6">
                                <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/79c1f999262389.5eef11b696d67.png" style="width: 100%; height: 550px; object-fit: cover;" class="text_ii">
                            </div>
                        </div>
                    </div>
                </div>
...
if (isset($_POST['submit'])) 
{
    ...
    $sql = " select * from regi where email = '$email' and pass = '$pass' ";
