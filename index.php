	...
	<div class="row">
		<div style="background:#fff; border-radius: 20px;">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<h4 class="text-success mt-5"><a href="User/view_product.php?id=<?php echo $row['id']; ?>" class="text-success"><?php echo $row['i_name']; ?></a></h5>
...
?>
      		...
      		<div class="col-md-4 mt-3">
      			<div class="container">
      				...
      				<h6 style="font-size: 16px; padding: 10px; text-align: center;  padding-top: 15px; width:100%; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;"><a href="User/view_product.php?id=<?php echo $row['id']; ?>" class="text-dark"><?php echo $row['i_name']; ?></a></h6>
